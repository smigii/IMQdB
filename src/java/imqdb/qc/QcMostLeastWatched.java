...
public class QcMostLeastWatched implements QueryController {
    ...
    @FXML private ListView artistSearchList;
...
//        }
        ...
        PreparedStatement ps = db.prepareStatement("select movies.original_title as Title from Movies limit 10");
...
//        );
    ...
    protected void onArtistSearchBtnClick()
    {
        ...
        ArrayList<ArtistSearchResult> artists = UtilQueries.artistLookup("%" + val + "%");
